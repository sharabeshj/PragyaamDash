...
import styles from "../../assets/jss/frontend/checkboxAndRadioStyle";
      ...
      >
        <div id="fixedPluginClasses" className={this.props.fixedClasses}>
          ...
          <ul className="dropdown-menu">
            <li className="header-title">Option 1</li>
            ...
            <li className="header-title">Option 2</li>
            <li className="adjustments-line">
              <a className="switch-trigger active-color">
                <div className="badge-colors text-center">
                  <span
            ...
            <li className="adjustments-line">
              <a className="switch-trigger">
                <p className="switch-label">Option 3</p>
                <Switch
            ...
            <li className="adjustments-line">
              <a className="switch-trigger">
                <p className="switch-label">Background Image</p>
                <Switch
